...
function Footer() {
  ...
  const footerItems = [
    { text: "CVG", path: "/" },
    { text: "Confidentialité", path: "/" },
    { text: "Mentions légales", path: "/" },
    { text: "Cookies", path: "/" },
  ];
  ...
  return (
    <footer className="justify-between space-y-2 bg-slate-100 p-4 font-poppins lg:flex lg:px-20">
      <LogoIcon />

      <div className="flex-col space-x-4 md:flex">
        <p className="font-bold">{helpNeededText}</p>

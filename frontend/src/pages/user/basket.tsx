  ...
  return (
    <main className="container flex mx-auto px-4 py-8 font-poppins">
          ...
          {cart.map((item) => (
            <div key={item.id} className="bg-white flex rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-48">
                <img className="m-5 max-w-28 object-contain" src={item.picture} alt={item.name} />
              </div>
      ...
      <div>
        ...
        <div className="bg-white p-5 mt-5 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="mt-4">
          <Link href="/">
            <div className="hover:underline">Continuer vos achats</div>
          </Link>
        </div>
      </div>
      {showConfirmation && (
